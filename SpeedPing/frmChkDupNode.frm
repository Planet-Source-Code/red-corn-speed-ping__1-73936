...
Private Function CheckDupNode() As Boolean
    ...
    If dupcount1 > 0 Then
        ...
        lblMsg1.Caption = "(有" & dupcount1 & "筆資料重複)"
    ...
    If dupcount2 > 0 Then
        ...
        lblMsg2.Caption = "(有" & dupcount2 & "筆資料重複)"
    ...
    If dupcount3 > 0 Then
        ...
        lblMsg3.Caption = "(有" & dupcount3 & "筆資料重複)"
    ...
    Exit Function
ErrHandler:
    MsgBox "執行資料重複的檢查時發生錯誤:" & vbCrLf & Err.Description, vbExclamation, MsgTitle
    cmdOK.Enabled = True
End Function
