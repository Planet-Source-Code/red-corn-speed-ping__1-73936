    ...
    Case WM_COPYDATA
        ...
        Select Case cdCopyData.dwData
            ...
            Case MSG_PINGCOLLECTOR_LOADPINGLIST_ERR
                ...
                MsgBox "PingCollector 載入的節點數量不符!", vbExclamation, MsgTitle
            ...
            Case MSG_PLS_PINGCOLLECTOR_CREATEAGENT '需要傳options(ini)
                ReplyMessage 1
            ...
            Case MSG_AGENT_SAYHELLO
                ...
                frmMain.AgentSayHello AgentID '改變燈號為黃色
...
Public Sub TellAgentToLoadINI(AgentID As Long)
    ...
    If aryAgentHwnd(AgentID) = 0 Then
        Exit Sub
    End If
    cdCopyData.dwData = MSG_AGENT_LOAD_INI '自定義數據
...
Public Sub TellCollectorToLoadList(num As Long)
    ...
    cdCopyData.dwData = MSG_PLS_PINGCOLLECTOR_LOADPINGLIST '自定義數據
...
Public Sub TellCollectorToLoadINI()
    ...
    cdCopyData.dwData = MSG_PLS_PINGCOLLECTOR_LOADINI '自定義數據
