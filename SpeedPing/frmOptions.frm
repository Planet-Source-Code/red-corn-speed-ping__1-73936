      ...
      Begin VB.PictureBox picOptions 
         ...
         Begin VB.Frame fra1 
            ...
            Begin VB.Label Label11 
               Caption         =   "Average RTT, Packet Loss% 統計 (default = 5 個ping循環)"
               Height          =   375
               Left            =   240
               TabIndex        =   30
               Top             =   5700
            ...
            Begin VB.Label Label2 
               Caption         =   "ping session 數 / 批次 / agent (default = 220 個)"
               Height          =   375
               Left            =   360
               TabIndex        =   22
               Top             =   6285
...
Private Sub SaveGlobalVars()
    If txtAgentCount > MaxAgent Then
        MsgBox "ping agent個數最大值" & MaxAgent, vbExclamation, MsgTitle
        txtAgentCount.SetFocus
        Exit Sub
    End If
'    If txtPingTimeOutHost > 6500 Then
'        MsgBox "最大值6500", vbExclamation, MsgTitle
